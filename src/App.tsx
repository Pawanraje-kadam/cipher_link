  ...
  return (
    <div className="min-h-page bg-ink-950 text-bone-100 relative">
      ...
      <main className="max-w-6xl mx-auto px-5 md:px-8 pt-12 md:pt-20 pb-24 safe-x safe-b">
        ...
        <header className="grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-8 mb-16 lg:mb-20">
          <div className="lg:col-span-8 min-w-0">
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1.5 mb-6">
              <span className="led bg-signal" />
              <span className="t-meta font-mono font-bold uppercase tracking-[0.22em] text-signal">
                cipherlink v1.0
              </span>
              <span className="text-bone-400">/</span>
              <span className="t-meta font-mono font-bold uppercase tracking-[0.22em] text-bone-300">
                in-browser only
              </span>
            </div>
            ...
            <h1 className="font-mono font-bold tracking-tight text-bone-50 t-display leading-[0.92] uppercase mb-6">
              Lock a message.<br />
              <span className="text-signal">Keep the key.</span>
            </h1>

            <p className="font-sans text-bone-100 font-bold t-lead leading-relaxed max-w-[52ch] mb-6">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 font-mono font-bold t-body uppercase tracking-[0.12em] text-bone-200">
          ...
          <aside className="lg:col-span-4 lg:pt-8 min-w-0">
            <div className="border-1 border-bone-500/40 bg-ink-900 shadow-inset">
              <div className="px-4 py-2.5 border-b-1 border-bone-500/40 bg-ink-950/60 flex items-center gap-2">
                ...
                <span className="t-meta font-mono font-bold uppercase tracking-[0.18em] text-bone-100">
                  cipher spec
                </span>
              </div>
              <dl className="p-4 t-body font-mono font-bold space-y-2.5 tabular">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 lg:items-start">
          <div className="min-w-0">
            <EncryptBox />
          </div>
          <div className="lg:mt-12 min-w-0">
            <DecryptBox />
          </div>
        </section>
        ...
        <footer className="mt-20 pt-6 border-t-1 border-bone-500/40 flex flex-col md:flex-row flex-wrap justify-between items-start md:items-center gap-x-6 gap-y-2 font-mono font-bold t-meta uppercase tracking-[0.14em] text-bone-300">
...
function Spec({ k, v }: { k: string; v: string }) {
  return (
    <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-0.5 lg:flex-nowrap">
...
function StatusBar() {
  ...
  return (
    <div className="border-b-1 border-bone-500/40 bg-ink-950 safe-t">
      <div className="max-w-6xl mx-auto px-5 md:px-8 min-h-10 flex flex-wrap items-center justify-between gap-y-1 py-1 font-mono font-bold t-micro uppercase tracking-[0.14em] text-bone-300 tabular">
